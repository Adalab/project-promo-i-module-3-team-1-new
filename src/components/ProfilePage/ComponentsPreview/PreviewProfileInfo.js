...
class PreviewProfileInfo extends React.Component {
  render() {
    return (
      ...
      <div id="PreviewProfileInfo" 
          className={`card__profileInfo--box ${this.props.value === "1" ? "infoStyle1" : this.props.value === "2" ? "infoStyle2" : this.props.value === "3" ? "infoStyle3" : "infoStyle4"}`}
      >
