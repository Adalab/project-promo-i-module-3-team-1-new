                ...
                <div className="form__open" id="form__share--open">
                    <div className="create-card-button-container">
                        <button id="createCardButton" 
                                type="button" 
                                className={`${this.props.mode === true ? 'Darkcreate-card-button' : "create-card-button"}`}                      
                    ...
                    <div className={`${this.props.mode === true ? 'Darkcreated-container' : "created-container"} ${this.props.cardSuccess === true ? '' : ' newHidden'}`}>
                        ...
                        <p className="linkResponse">
                            <a  href={this.props.cardURL}
                                target="_blank"
                                rel="noopener noreferrer">
                                {this.props.cardURL}
                            </a>
                        </p>
                        <a  href={`https://twitter.com/intent/tweet?&text=Echa%20un%20vistazo%20a%20mi%20tarjeta%20de%20visita%2C%20hecha%20con%20%23AwesomeProfileCards%3A%20${this.props.cardURL}&hashtags=Adalab%2C%20promoIdelisa`} 
                            id="shareOnTwitter" 
